...
function applyMenuStyleRules(sheet) {
    ...
    sheet.insertRule('.logo > img {margin-right: 10px;}');
...
function applyMobileMenuStyleRules(sheet) {
    ...
    sheet.insertRule('.menu-button {color: rgb(18, 60, 204); background-color: rgb(228, 219, 219); border-radius: 5px; padding: 5px 20px; position: relative; margin-top: 7px;}');
...
function applyContentStyleRules(sheet) {
    ...
    sheet.insertRule('.dot {height: 10px; width: 10px; margin-top: 40px; margin-left: 7px; margin-right: 7px;}');
    sheet.insertRule('.dot:hover{ border: 3px solid rgb(253, 186, 0); margin-top: 57px; margin-left: 4px; margin-top: 37px;}');
    sheet.insertRule('.btn {margin-top: 50px; color: white; background-color:rgb(217, 36, 48); border: none; border-radius: 3px; padding: 10px;}')
}
